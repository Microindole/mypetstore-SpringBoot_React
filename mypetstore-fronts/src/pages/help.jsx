...
const Help = () => {
    return (
        <div id="Content">
            ...
            <h2 id="Catalog">Working with the Product Catalog</h2>
            <p>This section describes how to browse and search the product catalog.</p>

            <h4 id="CatalogBrowsing">Browsing the Catalog</h4>
            <p>
            ...
            <h4 id="CatalogSearching">Searching the Catalog</h4>
            <p>
                You search for products by typing the product name in search field in the
                middle of the banner.
            </p>

            <h2 id="ShoppingCart">Working with the Shopping Cart</h2>

            <h4 id="ShoppingCartAdd">Adding and Removing Items</h4>
            <p>
            ...
            <h4 id="ShoppingCartUpdate">Updating the Quantity of an Item</h4>
            <p>
            ...
            <h4 id="Ordering">Ordering Items</h4>
            <p>
            ...
            <h2 id="OrderReview">Reviewing An Order</h2>
            <p>
